...
window.rangy = function() {
    ...
    if (typeof window == "undefined") C("No window found");
        ...
        if (l(window, "addEventListener")) window.addEventListener("load",
            q, false);
        ...
        l.util.extend(a.prototype, {
            ...
            normalizeBoundaries: function() {
                ...
                var m = this.startContainer,
                    ...
                    ga = true;
                if (g.isCharacterDataNode(y)) y.length ==
                F && Q(y);
                else {
    ...
    ca.prototype = {
        ...
        intersectsRange: function(a, e) {
            ...
            var j = g.comparePoints(this.startContainer,
                this.startOffset, a.endContainer, a.endOffset),
...
rangy.createModule("WrappedSelection", function(l, K) {
    ...
    var c = l.dom,
        ...
        p = c.DomPosition,
        u, w,
        B = l.util.isHostMethod(window, "getSelection"),
