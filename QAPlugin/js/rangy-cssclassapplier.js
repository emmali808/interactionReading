...
rangy.createModule("CssClassApplier", function(i, v) {
    ...
    function B(a, b) {
        for (var c = 0, d = a.attributes.length, e; c < d; ++c) {
            ...
            if (!(b &&
                h.arrayContains(b, e)) && a.attributes[c].specified && e != "class") return true
        }
        return false
    }
    ...
    function m(a, b, c, d) {
        ...
        if (h.isCharacterDataNode(b))
            if (c == 0) {
                ...
                b = b.parentNode
            } else throw v.createError("splitNodeAt should not be called with offset in the middle of a data node (" + c + " in " + b.data);
        var g;
        g = b;
        var j = c;
    ...
    function F(a) {
        ...
        return function(c, d) {
            ...
            if (f) {
                ...
                if ((f = e[b]) && f.nodeType == 1 && e.tagName == f.tagName && w(e, f) && A(e, f)) return f[a ?
    ...
    var h = i.dom,
        ...
        p;
    if (typeof window.getComputedStyle != "undefined") p = function(a, b) {
        return h.getWindow(a).getComputedStyle(a, null)[b]
    };
    else if (typeof document.documentElement.currentStyle != "undefined") p = function(a,
                                                                                       b) {
    ...
    (function() {
        k = typeof document.createElement("div").isContentEditable == "boolean" ? function(a) {
            ...
            if (!a || a.nodeType != 1 || a.contentEditable == "false") return false;
    ...
    q.prototype = {
        ...
        undoToTextNode: function(a, b, c) {
            if (!b.containsNode(c)) {
                ...
                if (a.isPointInRange(b.startContainer, b.startOffset)) c = m(c, b.startContainer, b.startOffset, [b])
            }
        ...
        isAppliedToRange: function(a) {
            if (a.collapsed) return !!this.getSelfOrAncestorWithClass(a.commonAncestorContainer);
                ...
                for (var b = a.getNodes([3]), c = 0, d; d = b[c++];)
                    if (!this.isIgnorableWhiteSpaceNode(d) && y(a, d) && this.isModifiable(d) && !this.getSelfOrAncestorWithClass(d)) return false;
                return true
            }
        },
